...
describe('createRequest', () => {
  ...
  context('successful calls', () => {
    const requests = [
      { name: 'id not supplied', testData: { data: { base: 'ETH', quote: 'USDT' } } },
      { name: 'base/quote', testData: { id: jobID, data: { base: 'ETH', quote: 'USDT' } } },
      { name: 'from/to', testData: { id: jobID, data: { from: 'ETH', to: 'USDT' } } },
      { name: 'coin/market', testData: { id: jobID, data: { coin: 'ETH', market: 'USDT' } } }
    ]
